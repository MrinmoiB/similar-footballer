# -*- coding: utf-8 -*-
"""
Created on Sun Jul  2 17:07:44 2023
...
def load_data():
    df = pd.read_csv('https://raw.githubusercontent.com/MrinmoiB/similar-footballer/main/Data/All_stats_combined_with_positions_22_23.csv', encoding='utf-8')
    gk_df = pd.read_csv('https://raw.githubusercontent.com/MrinmoiB/similar-footballer/main/Data/Gk_stats_combined_with_positions.csv', encoding='utf-8')
    return df,gk_df
df,gk_df = load_data()
...
st.header(' Find Players of Similar Profiles.')
st.caption('Only players of Europe\'s Top 5 Leagues and  the 2022/23 Season.')
...
def plot_radar(bkup,df,n):
    ...
    fig,ax = radar.plot_radar(ranges=ranges,params=new_params,values=values,
                             ...
                             alphas=alpha_list,show_values=False,
                             compare=True)
...
if (pos == 'Right-Back') or (pos == 'Left-Back') or (pos == 'Left WingBack') or (pos == 'Right WingBack'):
        radar_df = df[['Player','Squad','Age','Padj Tkl+Int p90 (defense_Padj_p90)','Percent of Dribblers Tackled (defense_Padj_p90)','Crs_p90 (passing_types_p90)',
                 'SCA_p90 (gca_p90)','Prog Passes_p90 (passing_p90)','Passes into Final 1/3_p90 (passing_p90)',
                 'Carries into Final 1/3_p90 (possession_p90)','xA per KP p90 (passing_p90)','TB_p90 (passing_types_p90)',
                 'True Interceptions_p90 (defense_p90)','Prog Carries_p90 per 100 touches (possession_p90)', 
                 'Prog Passes Received_p90 (stats_p90)', 'Def 3rd_p90 (possession_p90)', 'Mid 3rd_p90 (possession_p90)', 'Att 3rd_p90 (possession_p90)','Live_p90 (possession_p90)']]
        ...
        radar_df = df[['Player','Squad','Age','xA per KP p90 (passing_p90)','KP p90 per 50 passes (passing_p90)','Successful Dribbles_p90 (possession_p90)',
                 'Attempted Dribbles_p90 (possession_p90)','Passes into Penalty Area_p90 (passing_p90)','Passes into Final 1/3_p90 (passing_p90)',
                 'Carries into Penalty Area_p90 (possession_p90)','npxG_p90 (shooting_p90)', 'npxG/Sh_p90 (shooting_p90)',
                 'Crs_p90 (passing_types_p90)','TB_p90 (passing_types_p90)',
                 'Prog Carries_p90 per 100 touches (possession_p90)', 'Sh_p90 (shooting_p90)', 'SoT_p90 (shooting_p90)', 
        ...
        radar_df = df[['Player','Squad','Age','Successful Dribbles_p90 (possession_p90)',
                 'Padj Tkl+Int p90 (defense_Padj_p90)','Percent of Dribblers Tackled (defense_Padj_p90)',
                 'Completed Passes_p90 (passing_p90)','Long Cmp_p90 (passing_p90)','Long Att_p90 (passing_p90)',
                 'Prog Passes_p90 per 50 passes (passing_p90)', 'Def 3rd_p90 (possession_p90)', 'Mid 3rd_p90 (possession_p90)', 'Att 3rd_p90 (possession_p90)','Live_p90 (possession_p90)',
                 'Prog Carries_p90 per 100 touches (possession_p90)','Aerial Win Rate (misc_p90)','Won_p90 (misc_p90)',
        ...
        radar_df = df[['Player','Squad','Age','Successful Dribbles_p90 (possession_p90)', 'Sh_p90 (shooting_p90)',
                 'Completed Passes_p90 (passing_p90)','Prog Carries_p90 per 100 touches (possession_p90)', 'Def 3rd_p90 (possession_p90)', 'Mid 3rd_p90 (possession_p90)', 'Att 3rd_p90 (possession_p90)','Live_p90 (possession_p90)',
                 'Passes into Final 1/3_p90 (passing_p90)','Prog Carries_p90 (possession_p90)',
                 'Prog Passes_p90 (passing_p90)','Prog Passes_p90 per 50 passes (passing_p90)','Carries into Final 1/3_p90 (possession_p90)',
                 'Passes into Penalty Area_p90 (passing_p90)','Carries into Penalty Area_p90 (possession_p90)', 'Att Pen_p90 (possession_p90)',
        ...
        radar_df = df[['Player','Squad','Age','xA per KP p90 (passing_p90)','Passes into Penalty Area_p90 (passing_p90)',
                 'Carries into Penalty Area_p90 (possession_p90)','npxG_p90 (shooting_p90)', 'npxG/Sh_p90 (shooting_p90)',
                 'Sh_p90 (shooting_p90)', 'SoT_p90 (shooting_p90)','Aerial Win Rate (misc_p90)','Won_p90 (misc_p90)',
                 'Prog Passes Received_p90 (stats_p90)','SCA_p90 (gca_p90)','KP p90 per 50 passes (passing_p90)','Off_p90 (misc_p90)',
                 'Average Shot Distance (shooting_p90)', 'xAG_p90 (passing_p90)', 'xA_p90 (passing_p90)', 'Att Pen_p90 (possession_p90)',
        ...
        radar_df = df[['Player', 'Squad', 'Age', 'PSxG_p90 (keepersadv_p90)', 'PSxG/SoT_p90 (keepersadv_p90)', 'PSxG+/-_p90 (keepersadv_p90)',
       'Cmp_p90 (keepersadv_p90)', 'Att_p90 (keepersadv_p90)', 'Passes Att_p90 (keepersadv_p90)', 'Thr_p90 (keepersadv_p90)',
       'AvgLen_p90 (keepersadv_p90)', 'Goal Kicks Att_p90 (keepersadv_p90)', 'Goal Kicks AvgLen_p90 (keepersadv_p90)', 'Opp_p90 (keepersadv_p90)',
       'Stp_p90 (keepersadv_p90)', '#OPA_p90 (keepersadv_p90)', 'SoTA_p90 (keepers_p90)', 'Saves_p90 (keepers_p90)', 'CS_p90 (keepers_p90)', 'PKsv_p90 (keepers_p90)']]
        # df = df[['Player','Squad','Age','SoTA_p90 (keepers_p90)', 'Saves_p90 (keepers_p90)','Stp_p90 (keepersadv_p90)',
        ...
        radar_df = df[['Player','Squad','Age','Successful Dribbles_p90 (possession_p90)', 'Sh_p90 (shooting_p90)', 'SoT_p90 (shooting_p90)',
                 'Passes into Penalty Area_p90 (passing_p90)','Carries into Penalty Area_p90 (possession_p90)', 'Att Pen_p90 (possession_p90)',
                 'xA per KP p90 (passing_p90)','KP p90 per 50 passes (passing_p90)','npxG_p90 (shooting_p90)','SCA_p90 (gca_p90)',
                 'Aerial Win Rate (misc_p90)','Won_p90 (misc_p90)', 'Prog Passes Received_p90 (stats_p90)','Passes into Final 1/3_p90 (passing_p90)',
                 'npxG/Sh_p90 (shooting_p90)','Off_p90 (misc_p90)','Average Shot Distance (shooting_p90)', 'Mid 3rd_p90 (possession_p90)', 'Att 3rd_p90 (possession_p90)','Live_p90 (possession_p90)']]
